...
from sklearn.model_selection import train_test_split
 ...
 # ACA SUMAMOS LOS DATOS DE LOS DIFERENTES KILOMETROS CAMINADOS EN DIFERENTES TIEMPOS REGISTRADOS
...
kilometros = [0,0,0.5,0.5,6.7,1,1,2.2,3,2,2.8,3.5,3.7,4,5,5.5,6,3,6,6,6,7,7.2,8,6.9,7,7.4,7.5,7,8,8.2,8.5,4.2,9,4.3,7.2,2,9.3,7,10]
...
# EL WHILE NO PARA HASTA QUE EL CALCULO MATEMATICO A LLEGADO A UN PRECISION
while True:
...
print("Basándonos en las caminatas anteriores, vas a caminar aproximadamente: ")
